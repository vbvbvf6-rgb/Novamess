...
**How to apply:** Keep `supportedArchitectures.libc` set to both `glibc` and `musl` in the workspace package configuration, and verify the lockfile includes the matching Linux native packages after dependency changes.